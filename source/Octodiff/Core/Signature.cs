...
namespace Octodiff.Core
{
    ...
    {
        public Signature(IHashAlgorithm hashAlgorithm, IRollingChecksum rollingChecksumAlgorithm, byte[] basisFileHash)
        {
            HashAlgorithm = hashAlgorithm;
            RollingChecksumAlgorithm = rollingChecksumAlgorithm;
            BasisFileHash = basisFileHash;
        ...
        public byte[] BasisFileHash { get; private set; }
